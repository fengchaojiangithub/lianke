		...
		<ul id="uls">
			...
			<tr>
				...
				<td class="problem" colspan="2">
				   ...
				   <a href="<?php echo U('Question/question_page');?>?id=<?php echo $val['id']?>"><?php echo $val['title'];?></a>

				<?php if($val['money']){ ?>
				   <div class="xuanshang">
					   <div class="xs_left">悬赏</div>
						   <div class="xs_right"><span>	
						  <?php echo $val['money'];?></span>
						   <img src="/Public/Index/img/k_03.jpg"/>
						   </div>						 
				   </div>
				     <?php }?>
	            </td>
			...
			<tr>
				<td class="d2">
					...
					<span class="time"> 
					<?php
 echo jishuantime($val['quiz_time']); ?>
					</span>

					<div class="gn">
						<span><img src="/Public/Index/img/ll.jpg"/>
							<kbd><?php echo $val['click'];?></kbd>
						</span>
						<span>
							<img src="/Public/Index/img/pl.jpg"/>
							<kbd><?php echo $val['answer_count'];?></kbd>
						</span>
					</div>
				</td>
			</tr>
...
//       	页面到达底部时
        ...
        var lastid = $('#uls').children('li:last-child').attr('id');
             //  alert(lastid );
          $.ajax({
                        type:"get",
                            ...
                            // var getdata = msg.data;  
                             for (var i = 0; i < msg.length; i++) {
                                   ...
                                   var str='<li id='+msg[i].id+'><table><tr><td rowspan="2" class="d1"><div class="tx_out">'+user_face+face+'</div></td><td class="problem" colspan="2"><a href="/index.php/Home/Index/question_page?id='+msg[i].id+'">'+msg[i].title+'</a>'+xuanshang+'</td></tr><tr><td class="d2"><span class="name">'+msg[i].user_name+'</span><span class="time">'+quiz_time+'</span><div class="gn"><span><img src="/Public/Index/img/ll.jpg"/><kbd>'+msg[i].click+'</kbd></span><span><img src="/Public/Index/img/pl.jpg"/><kbd>'+msg[i].answer_count+'</kbd></span></div></td></tr></table><img src="/Public/Index/img/wh.png" class="status"/></li>';
                             	$('#uls').append(str);
                             }
